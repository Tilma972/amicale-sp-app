...
// DonsDetailsList is not present in this repo snapshot
...
export default function ClotureModal({ tourneeActive, onClose, onSuccess }: ClotureModalProps) {
  ...
  const addPendingTransaction = (t: any) => { console.log('Pending txn', t); };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      body: JSON.stringify({
        ...
        user_id: user.id,
        team_id: tourneeActive.team_id ?? null,
  ...
  const updateDonsAvecRecus = (dons: DonAvecRecu[]) => {
