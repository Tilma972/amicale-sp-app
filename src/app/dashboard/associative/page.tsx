...
const mockEvenements: Evenement[] = [
  {
    ...
    description: 'Bilan de l\'année et projets 2025. Présence obligatoire pour tous les membres.',
    date: '2024-02-15',
    heure: '19:00',
  ...
  },
  {
    ...
    description: 'Moment convivial entre collègues autour de la traditionnelle galette.',
    date: '2024-01-20',
    heure: '18:30',
...
const mockNaissances: Naissance[] = [
  {
    ...
    poids: '3,2 kg',
    message: 'Nous sommes heureux de vous annoncer la naissance de notre petite Emma !',
    equipe: 'Équipe Alpha'
  },
  {
    id: '2',
...
const mockInfosPratiques: InfoPratique[] = [
  {
    ...
    contenu: 'Les nouveaux badges d\'accès seront distribués la semaine prochaine. Pensez à ramener vos anciens badges.',
  ...
  },
  {
    ...
    contenu: 'Le parking principal sera en travaux du 20 au 25 janvier. Utilisez le parking secondaire.',
...
export default function AnnoncesEvenementsPage() {
  ...
  const getTypeEvenementColor = (type: string) => {
    switch (type) {
      case 'assemblee': return 'bg-red-100 text-red-800'
      case 'soiree': return 'bg-purple-100 text-purple-800'
  ...
  const getTypeEvenementLabel = (type: string) => {
    switch (type) {
      case 'assemblee': return 'Assemblée'
  ...
  const getEtatMaterielColor = (etat: string) => {
    switch (etat) {
      ...
      case 'a_reviser': return 'bg-red-100 text-red-800'
      default: return 'bg-gray-100 text-gray-800'
    }
  }
  ...
  const handleDemanderPret = (materielId: string) => {
    ...
    toast.textContent = 'Demande de prêt envoyée !'
                ...
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      {naissance.message && (
                        <p className="text-gray-700 italic bg-pink-50 p-3 rounded-lg">
                          &quot;{naissance.message}&quot;
                        </p>
                      )}
                    </div>
                ...
                <Card key={materiel.id} className="overflow-hidden">
                  <CardContent className="p-4">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <Badge className={getEtatMaterielColor(materiel.etat)}>
                        {materiel.etat}
                      </Badge>
                    </div>
                      ...
                      {!materiel.disponible && (
                        <div className="bg-orange-50 border border-orange-200 rounded p-2 mt-3">
                          <div className="flex justify-between text-xs">
                            <span>Emprunté par: <strong>{materiel.emprunte_par}</strong></span>
                          </div>
                          <div className="flex justify-between text-xs mt-1">
                            <span>Retour prévu: {materiel.date_retour_prevue && formatDateCourt(materiel.date_retour_prevue)}</span>
                          </div>
                        </div>
                      )}
                    </div>
              ...
              <Card key={info.id} className={`border-l-4 ${getPrioriteColor(info.priorite)}`}>
                <CardContent className="p-4">
                  ...
                  <div className="flex items-center justify-between text-xs text-gray-500">
                    <span>Par {info.auteur} • {formatDateCourt(info.date_creation)}</span>
                    {info.valide_jusqu && (
              ...
              <div className="bg-orange-50 border border-orange-200 rounded-lg p-3">
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-sm text-orange-800">
                    En cas de casse ou de perte, la caution sera retenue. 
                    Le matériel doit être rendu dans l&apos;etat o&ugrave; il a &eacute;t&eacute; emprunt&eacute;.
                  </p>
                </div>
              </div>
